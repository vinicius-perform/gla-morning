# GLA MORNING — Landing Page Oficial

Landing Page exclusiva desenvolvida para o evento **GLA MORNING**, idealizado por **Glaucia Peron** em parceria com a **Domcore Academia**.
...
- Use uma extensão como *Live Server* no VS Code / IDE.

---

## ⚙️ Personalização Rápida

Para definir o número de WhatsApp que receberá as mensagens:
1. Abra o arquivo `index.html`.
2. Procure por `https://wa.me/?text=` na função `handleFormSubmit` (por volta da linha 410) ou no link direto do modal.
3. Adicione o número com o DDI e DDD (exemplo: `https://wa.me/5511999999999?text=`).
